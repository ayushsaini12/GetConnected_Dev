...
You can see the full change in [routes/api/profile.js](https://github.com/ayushsaini12/GetConnected_Dev/blob/main/routes/api/profile.js)

## uuid no longer has a default export

The npm package [uuid](https://www.npmjs.com/package/uuid) no longer has a default export, so in our [client/src/actions/alert.js](https://github.com/ayushsaini12/GetConnected_Dev/blob/main/client/src/actions/alert.js) we need to change the import and use of this package.
...
You can see the use here in [routes/api/profile.js](https://github.com/ayushsaini12/GetConnected_Dev/blob/main/routes/api/profile.js)
...
You can see the code use here in [routes/api/users.js](https://github.com/ayushsaini12/GetConnected_Dev/blob/main/routes/api/user.js)
...
The subscription can be seen in [client/src/store.js](https://github.com/ayushsaini12/GetConnected_Dev/blob/main/client/src/store.js)

We also need to change our [client/src/utils/setAuthToken.js](https://github.com/ayushsaini12/GetConnected_Dev/blob/main/client/src/utils/setAuthToken.js) so it now handles both the setting of the token in local storage and in axios headers.
`setauthToken.js` in turn depends on [client/src/utils/api.js](https://github.com/ayushsaini12/GetConnected_Dev/blob/main/client/src/utils/api.js) where we create an instance of axios. So you will also need to grab that file.

With those two changes in place we can remove all setting of local storage from [client/src/reducers/auth.js](https://github.com/ayushsaini12/GetConnected_Dev/blob/main/client/src/reducers/auth.js). And remove setting of the token in axios headers from [client/src/actions/auth.js](https://github.com/ayushsaini12/GetConnected_Dev/blob/master/client/src/actions/auth.js). This helps keep our code predictable, manageable and ultimately bug free.

## Component reuse ♻️

The EditProfile and CreateProfile have been reduced to one component [ProfileForm.js](https://github.com/ayushsaini12/GetConnected_Dev/blob/main/client/src/components/profile-forms/ProfileForm.js)  
...
**You can see the implementation of the interceptor and axios instance in [utils/api.js](https://github.com/ayushsaini12/GetConnected_Dev/blob/main/client/src/utils/api.js)**

Creating an instance of axios also cleans up our action creators in [actions/auth.js](https://github.com/ayushsaini12/GetConnected_Dev/blob/main/client/src/actions/auth.js), [actions/profile.js](https://github.com/ayushsaini12/GetConnected_Dev/blob/main/client/src/actions/profile.js) and [actions/post.js](https://github.com/ayushsaini12/GetConnected_Dev/blob/main/client/src/actions/post.js)

Note that implementing this change also requires that you use the updated code in [utils/setAuthToken.js](https://github.com/ayushsaini12/GetConnected_Dev/blob/main/client/src/utils/setAuthToken.js)
Which also in turn depends on [utils/api.js](https://github.com/ayushsaini12/GetConnected_Dev/blob/main/client/src/utils/api.js)
...
Some of you in the course have been having problems installing both packages and meeting peer dependencies.\
 ...
 First create a [ utils/formatDate.js ](https://github.com/ayushsaini12/GetConnected_Dev/blob/main/client/src/utils/formatDate.js) file, with the following code...
...
Then in our [Education.js](https://github.com/ayushsaini12/GetConnected_Dev/blob/main/client/src/components/dashboard/Education.js) component, import the new function...
...
- [Education.js](https://github.com/ayushsaini12/GetConnected_Dev/blob/main/client/src/components/dashboard/Education.js)
- [Experience.js](https://github.com/ayushsaini12/GetConnected_Dev/blob/main/client/src/components/dashboard/Experience.js)
- [CommentItem.js](https://github.com/ayushsaini12/GetConnected_Dev/blob/main/client/src/components/post/CommentItem.js)
- [PostItem.js](https://github.com/ayushsaini12/GetConnected_Dev/blob/main/client/src/components/posts/PostItem.js)
- [ProfileEducation.js](https://github.com/ayushsaini12/GetConnected_Dev/blob/master/client/src/components/profile/ProfileEducation.js)
- [ProfileExperience.js](https://github.com/ayushsaini12/GetConnected_Dev/blob/master/client/src/components/profile/ProfileExperience.js)
...
their [ own styling ](https://github.com/ayushsaini12/GetConnected_Dev/blob/main/client/src/App.css) so they are `position: fixed;` and we get no content shift,
